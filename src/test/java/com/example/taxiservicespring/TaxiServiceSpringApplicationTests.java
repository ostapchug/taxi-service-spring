...
class TaxiServiceSpringApplicationTests {
    ...
    void getAllTest() {
        PersonDto testPersonDto = createPersonDto();
        List<PersonDto> personDtoList = testRestTemplate.exchange(baseUrl, HttpMethod.GET, null, new ParameterizedTypeReference<List<PersonDto>>() {}).getBody();
    ...
    void updatePersonTest() {
        ...
        PersonDto personDto = testRestTemplate.exchange(baseUrl + "/" + PHONE, HttpMethod.PUT, entity, PersonDto.class).getBody();
