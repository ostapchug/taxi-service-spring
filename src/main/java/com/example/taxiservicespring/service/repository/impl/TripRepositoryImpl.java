...
public class TripRepositoryImpl implements TripRepository {
	...
	public List<Trip> findAll(int offset, int count, String sorting) {
		...
		int fromIndex = offset >= result.size() ? result.size() - count : offset;
		int toIndex = count + fromIndex > result.size() ? result.size() : count + fromIndex;
